...
public class ModItems {
    ...
    public static final RegistryObject<Item> ALCOHOL_BOTTLE = ITEMS.register("alcohol_bottle", AlcoholBottleItem::new);
    public static final RegistryObject<Item> ANTISERUM_INJECTOR = ITEMS.register("antiserum_injector",AntiserumInjectorItem::new);
    public static final RegistryObject<Item> ANTIBIOTICS_PILLS = ITEMS.register("antibiotics_pill_bottle",AntibioticsItem::new);
    public static final RegistryObject<Item> ANTISEPTIC_SPRAY = ITEMS.register("antiseptic_spray_bottle",AntisepticSprayItem::new);
    public static final RegistryObject<Item> PROCOAGULANT_INJECTOR = ITEMS.register("procoagulant_injector",ProcoagulantInjectorItem::new);
    public static final RegistryObject<Item> STREPTOKINASE_INJECTOR = ITEMS.register("streptokinase_injector", StreptokinaseInjectorItem::new);
    public static final RegistryObject<Item> BRAIN_GROW_PILLS = ITEMS.register("brain_grow_pill_bottle",BrainGrowPillItem::new);
    public static final RegistryObject<Item> CEFTRIAXONE_VIAL = ITEMS.register("ceftriaxone_vial", CeftriaxoneVialItem::new);
    public static final RegistryObject<Item> FENTANYL_VIAL = ITEMS.register("fentanyl_vial",FentanylVialItem::new);
    public static final RegistryObject<Item> HEROIN_SYRINGE = ITEMS.register("heroin_syringe",HeroinSyringeItem::new);
    ...
    public static final RegistryObject<Item> PAINKILLERS_PILLS = ITEMS.register("painkillers_pill_bottle",PainkillersPillItem::new);
    public static final RegistryObject<Item> SALINE_SYRINGE = ITEMS.register("saline_bag", SalineSyringeItem::new);
    public static final RegistryObject<Item> RELIEF_CREAM_BOTTLE = ITEMS.register("relief_cream_bottle",ReliefCreamBottle::new);
