...
import net.zaharenko424.casualties_cubed.fluid_system.*;
...
public class ModFluids {
    ...
    public static final RegistryObject<FluidType> MEDICAL_TYPE = FLUID_TYPES.register("medical", () -> new FluidType(FluidType.Properties.create()));
    public static final RegistryObject<FlowingFluid> SRC_MEDICAL = FLUIDS.register("medical_fluid", () -> new ForgeFlowingFluid.Source(ModFluids.MEDICAL_PROPERTIES));
    ...
    public static final RegistryObject<FluidType> CLEAN_WATER_TYPE = FLUID_TYPES.register("clean_water", () -> new MedicalFluidType(FluidType.Properties.create(), 0x5276d1));
    public static final RegistryObject<MedicalFluid> CLEAN_WATER = FLUIDS.register("clean_water", () -> new MedicalFluid(new ForgeFlowingFluid.Properties(ModFluids.CLEAN_WATER_TYPE, ModFluids.CLEAN_WATER, ModFluids.CLEAN_WATER), MedicalEffect.EMPTY));
