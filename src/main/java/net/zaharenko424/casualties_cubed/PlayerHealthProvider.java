...
public class PlayerHealthProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    public static Capability<PlayerHealthData> PLAYER_HEALTH_DATA = CapabilityManager.get(new CapabilityToken<>() {});
    ...
    public CompoundTag serializeNBT() {
        return createPlayerHealthData().serializeToDisk();
    }

    @Override
    public void deserializeNBT(CompoundTag nbt) {
        createPlayerHealthData().deserializeFromDisk(nbt);
    }
}
