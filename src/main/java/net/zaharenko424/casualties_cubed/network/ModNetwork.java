...
public class ModNetwork {
    ...
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(
            CasualtiesCubed.resourceLoc("main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void registerPackets() {
        ...
        registerServerbound(ServerboundTransferFluidPacket.class, ServerboundTransferFluidPacket::encode,
                ServerboundTransferFluidPacket::new, ServerPacketHandler::handleTransferFluid);
