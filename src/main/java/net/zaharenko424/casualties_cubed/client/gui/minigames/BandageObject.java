...
import net.zaharenko424.casualties_cubed.item.bandages.PlasticDressingItem;
import net.zaharenko424.casualties_cubed.item.bandages.SterilizedDressingItem;
