...
public class FracturedRibsMoodle extends AbstractMoodle {

    private static final ResourceLocation TEX = CasualtiesCubed.resourceLoc("textures/gui/moodles/broken_ribs_moodle.png");

    public FracturedRibsMoodle() {
        super(false, true);
    }

    @Override
    public void update(Player player, PlayerHealthData data) {
        float timer = data.getLimb(Limb.CHEST).getBoneHealTimer();//TODO replace with thorax
