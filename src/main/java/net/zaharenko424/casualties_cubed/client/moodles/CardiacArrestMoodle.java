...
public class CardiacArrestMoodle extends AbstractMoodleVisual {
    ...
    public List<Component> getTooltip(Player player) {
        return List.of(Component.translatable("gui.casualties_cubed.moodle.cardiac_arrest.title"),
                       Component.translatable("gui.casualties_cubed.moodle.cardiac_arrest.description"));
    }
}
