...
public class ReducedContiousnessOverlay implements IOverlay {
    ...
    private static final ResourceLocation TEX = CasualtiesCubed.resourceLoc("textures/gui/icons/brain.png");
    ...
    public void calculate(Player player) {
        player.getCapability(PlayerHealthProvider.PLAYER_HEALTH_DATA).ifPresent(h -> {
            intensity = (70 - Math.max(h.consciousness() - 30, 0)) / 70;
            dying = h.bloodOxygen() < 4;
            brain = h.brainHealth();
        });
    }
}
