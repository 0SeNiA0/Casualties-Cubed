...
public class HealthInfoBoxWidget extends AbstractWidget {
    ...
    private static final ResourceLocation main_tex = CasualtiesCubed.resourceLoc("textures/gui/info_box.png");
    private static final ResourceLocation blood_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/blood_drop.png");
    private static final ResourceLocation pain_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/pain.png");
    private static final ResourceLocation infection_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/inf.png");
    private static final ResourceLocation bloodBag_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/blood_bag.png");
    private static final ResourceLocation consciousness_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/conc_sprites.png");
    private static final ResourceLocation opiate_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/opiate_meter.png");
    private static final ResourceLocation brain_tex = CasualtiesCubed.resourceLoc("textures/gui/icons/brain.png");
    ...
    protected void renderWidget(GuiGraphics guiGraphics, int i, int i1, float v) {
        ...
        guiGraphics.blit(consciousness_tex, 7, 16, 0, blitV * 16, 16, 16, 16, 80);
        if (contiousness < 40) {
            if (blink) {
