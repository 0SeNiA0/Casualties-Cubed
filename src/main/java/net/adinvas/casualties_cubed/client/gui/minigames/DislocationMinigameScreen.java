...
import net.adinvas.casualties_cubed.network.packet.ServerboundDislocationTryPacket;
...
public class DislocationMinigameScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        guiGraphics.blit( CasualtiesCubed.resourceLoc("textures/gui/limbs/bone2.png"),this.width/2-160,this.height/2-40,0,0,160,80,160,80);
        guiGraphics.setColor(0.5f,0.5f,0.5f,0.1f);
        guiGraphics.blit( CasualtiesCubed.resourceLoc("textures/gui/limbs/bone.png"),this.width/2,this.height/2-40,0,0,160,80,160,80);
