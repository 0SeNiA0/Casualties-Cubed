...
import net.adinvas.casualties_cubed.item.bandages.PlasticDressingItem;
import net.adinvas.casualties_cubed.item.bandages.SterilizedDressingItem;
import net.adinvas.casualties_cubed.limbs.Limb;
import net.adinvas.casualties_cubed.network.ModNetwork;
import net.adinvas.casualties_cubed.network.packet.ServerboundUseBandagePacket;
