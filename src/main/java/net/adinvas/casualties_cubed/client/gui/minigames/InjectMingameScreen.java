...
import net.adinvas.casualties_cubed.network.packet.ServerboundExchangeItemInBagPacket;
import net.adinvas.casualties_cubed.network.packet.ServerboundExchangeItemInHandPacket;
import net.adinvas.casualties_cubed.network.ModNetwork;
import net.adinvas.casualties_cubed.network.packet.ServerboundSyringeFailPacket;
