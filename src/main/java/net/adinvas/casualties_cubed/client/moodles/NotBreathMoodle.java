...
public class NotBreathMoodle extends AbstractMoodleVisual {
    ...
    public List<Component> getTooltip(Player player) {
        ...
        componentList.add(Component.translatable("casualties_cubed.gui.moodle.not_breathing.title4").withStyle(ChatFormatting.GOLD));
        componentList.add(Component.translatable("casualties_cubed.gui.moodle.not_breathing.description4").withStyle(ChatFormatting.GRAY));
