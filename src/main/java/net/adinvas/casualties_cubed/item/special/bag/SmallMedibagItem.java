...
import net.adinvas.casualties_cubed.menu.SmallMedibagMenu;
...
public class SmallMedibagItem extends Item implements IBag {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.casualties_cubed.small_medibag.description").withStyle(ChatFormatting.GRAY));
    }
