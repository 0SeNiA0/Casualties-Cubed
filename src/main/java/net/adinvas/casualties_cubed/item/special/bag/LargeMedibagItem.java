package net.adinvas.casualties_cubed.item.special.bag;

import net.adinvas.casualties_cubed.item.api.IBag;
import net.adinvas.casualties_cubed.menu.LargeMedibagMenu;
...
public class LargeMedibagItem extends Item implements IBag {
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.translatable("item.casualties_cubed.large_medibag.description").withStyle(ChatFormatting.GRAY));
    }
