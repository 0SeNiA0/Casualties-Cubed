...
public class JEIFluidPlugin implements IModPlugin {
    ...
    private static final ResourceLocation ID = CasualtiesCubed.resourceLoc( "jei_fluid");
    ...
    public void registerExtraIngredients(IExtraIngredientRegistration registration) {
        ...
        for (RegistryObject<MedicalFluid> medicalFluidRegistryObject: ModMedicalFluids.MEDICAL_FLUIDS.getEntries()) {
            ...
            CasualtiesCubed.LOGGER.info("fs {} id {}",fs.getFluid(),medicalFluidRegistryObject.getId().toString());
