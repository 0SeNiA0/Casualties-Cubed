...
import net.adinvas.casualties_cubed.blocks.BrownCapBlock;
import net.adinvas.casualties_cubed.blocks.GlowFruitBushBlock;
import net.adinvas.casualties_cubed.blocks.ScavBlock;
import net.adinvas.casualties_cubed.blocks.medical_mixer.MedicalMixerBlock;
