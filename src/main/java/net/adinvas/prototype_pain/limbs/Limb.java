...
public enum Limb {
    HEAD(Component.translatable("prototype_pain.limb.head")),
    CHEST(Component.translatable("prototype_pain.limb.chest")),
    LEFT_ARM(Component.translatable("prototype_pain.limb.larm")),
    RIGHT_ARM(Component.translatable("prototype_pain.limb.rarm")),
    RIGHT_HAND(Component.translatable("prototype_pain.limb.rhand")),
    LEFT_HAND(Component.translatable("prototype_pain.limb.lhand")),
    LEFT_LEG(Component.translatable("prototype_pain.limb.lleg")),
    RIGHT_LEG(Component.translatable("prototype_pain.limb.rleg")),
    LEFT_FOOT(Component.translatable("prototype_pain.limb.lfoot")),
    RIGHT_FOOT(Component.translatable("prototype_pain.limb.rfoot"));
